...
void SpecificMonitor::readConfig(RoboCompCommonBehavior::ParameterList &params )
{
	...
	configGetString("", "UseCGR", aux.value,"false");
	params["UseCGR"] = aux;
	
	configGetString("", "CGRWeight", aux.value,"0");
	params["CGRWeight"] = aux;
	
	configGetString("", "UseApril", aux.value,"false");
	params["UseApril"] = aux;
	
	configGetString("", "AprilWeight", aux.value,"0");
