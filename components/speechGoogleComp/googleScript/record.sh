...
wget -U 'Mozilla/5.0' --post-file $1.flac --header="Content-Type: audio/x-flac; rate=16000" -O - 'http://www.google.com/speech-api/v2/recognize?output=json&lang=es_ES&key=AIzaSyD6Feqm6zop25JcQbtKkyjt4085wigBCz4' > $speech.json
