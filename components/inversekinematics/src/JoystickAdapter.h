...
struct TData
{
    ...
    std::tuple<const ::RoboCompJoystickAdapter::AxisList&, const ::RoboCompJoystickAdapter::ButtonsList&, const int&, const int&, const ::std::string&> ice_tuple() const
    {
        return std::tie(axes, buttons, velAxisIndex, dirAxisIndex, id);
    }
};
...
struct StreamReader<::RoboCompJoystickAdapter::TData, S>
{
    ...
    {
        istr->readAll(v.axes, v.buttons, v.velAxisIndex, v.dirAxisIndex, v.id);
    }
};
...
struct AxisParams
{
    ...
    bool operator==(const AxisParams& rhs_) const
    {
        if(this == &rhs_)
        {
            return true;
...
struct TData
{
    ...
    bool operator==(const TData& rhs_) const
    {
        ...
        if(buttons != rhs_.buttons)
        {
            return false;
        }
        if(velAxisIndex != rhs_.velAxisIndex)
        {
            return false;
        }
        if(dirAxisIndex != rhs_.dirAxisIndex)
        {
            return false;
        }
        if(id != rhs_.id)
    ...
    bool operator<(const TData& rhs_) const
    {
        ...
        else if(rhs_.velAxisIndex < velAxisIndex)
        {
            return false;
        }
        if(dirAxisIndex < rhs_.dirAxisIndex)
        ...
        else if(rhs_.dirAxisIndex < dirAxisIndex)
        {
            return false;
        }
        if(id < rhs_.id)
