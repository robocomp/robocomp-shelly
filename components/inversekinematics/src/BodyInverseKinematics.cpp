...
void
IceProxy::RoboCompBodyInverseKinematics::BodyInverseKinematics::setJoint(const ::std::string& joint, ::Ice::Float position, ::Ice::Float maxSpeed, const ::Ice::Context* __ctx)
{
    ...
    while(true)
    {
        ...
        try
        {
            __delBase = __getDelegate(false);
            ::IceDelegate::RoboCompBodyInverseKinematics::BodyInverseKinematics* __del = dynamic_cast< ::IceDelegate::RoboCompBodyInverseKinematics::BodyInverseKinematics*>(__delBase.get());
            __del->setJoint(joint, position, maxSpeed, __ctx, __observer);
            return;
        }
        catch(const ::IceInternal::LocalExceptionWrapper& __ex)
        {
...
::Ice::AsyncResultPtr
IceProxy::RoboCompBodyInverseKinematics::BodyInverseKinematics::begin_setJoint(const ::std::string& joint, ::Ice::Float position, ::Ice::Float maxSpeed, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
...
void
IceDelegateM::RoboCompBodyInverseKinematics::BodyInverseKinematics::setJoint(const ::std::string& joint, ::Ice::Float position, ::Ice::Float maxSpeed, const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
...
void
IceDelegateD::RoboCompBodyInverseKinematics::BodyInverseKinematics::setJoint(const ::std::string& joint, ::Ice::Float position, ::Ice::Float maxSpeed, const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:

        _DirectI(const ::std::string& __p_joint, ::Ice::Float __p_position, ::Ice::Float __p_maxSpeed, const ::Ice::Current& __current) : 
            ::IceInternal::Direct(__current),
            _m_joint(__p_joint),
            _m_position(__p_position),
        ...
        run(::Ice::Object* object)
        {
            ...
            servant->setJoint(_m_joint, _m_position, _m_maxSpeed, _current);
            return ::Ice::DispatchOK;
        }
    ...
    try
    {
        _DirectI __direct(joint, position, maxSpeed, __current);
        try
        {
            __direct.getServant()->__collocDispatch(__direct);
        }
...
RoboCompBodyInverseKinematics::BodyInverseKinematics::___setJoint(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    __is->read(maxSpeed);
    __inS.endReadParams();
    setJoint(joint, position, maxSpeed, __current);
    __inS.__writeEmptyParams();
    return ::Ice::DispatchOK;
}
