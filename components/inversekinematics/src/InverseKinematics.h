...
typedef ::std::map< ::std::string, ::Ice::Float> ScalarMap;
...
class Callback_InverseKinematics_mapBasedTarget_Base : virtual public ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_InverseKinematics_mapBasedTarget_Base> Callback_InverseKinematics_mapBasedTargetPtr;
...
public:
    ...
    ::Ice::Int mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars)
    {
        return mapBasedTarget(bodyPart, strings, scalars, 0);
    }
    ::Ice::Int mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars, const ::Ice::Context& __ctx)
    {
        return mapBasedTarget(bodyPart, strings, scalars, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_mapBasedTarget(bodyPart, strings, scalars, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_mapBasedTarget(bodyPart, strings, scalars, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_mapBasedTarget(bodyPart, strings, scalars, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_mapBasedTarget(bodyPart, strings, scalars, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        class Cpp11CB : public ::IceInternal::Cpp11FnCallbackNC
        {
        public:
            ...
            virtual void __completed(const ::Ice::AsyncResultPtr& __result) const
            {
                ...
                try
                {
                    __ret = __proxy->end_mapBasedTarget(__result);
                }
                catch(::Ice::Exception& ex)
                {
                    Cpp11FnCallbackNC::__exception(__result, ex);
        ...
        return begin_mapBasedTarget(bodyPart, strings, scalars, __ctx, new Cpp11CB(__response, __exception, __sent));
    }
    
public:
#endif

    ::Ice::AsyncResultPtr begin_mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars)
    {
        return begin_mapBasedTarget(bodyPart, strings, scalars, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars, const ::Ice::Context& __ctx)
    {
        return begin_mapBasedTarget(bodyPart, strings, scalars, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_mapBasedTarget(bodyPart, strings, scalars, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_mapBasedTarget(bodyPart, strings, scalars, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars, const ::RoboCompInverseKinematics::Callback_InverseKinematics_mapBasedTargetPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_mapBasedTarget(bodyPart, strings, scalars, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_mapBasedTarget(const ::std::string& bodyPart, const ::RoboCompInverseKinematics::StringMap& strings, const ::RoboCompInverseKinematics::ScalarMap& scalars, const ::Ice::Context& __ctx, const ::RoboCompInverseKinematics::Callback_InverseKinematics_mapBasedTargetPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_mapBasedTarget(bodyPart, strings, scalars, &__ctx, __del, __cookie);
    }

    ::Ice::Int end_mapBasedTarget(const ::Ice::AsyncResultPtr&);
    
private:

    ::Ice::Int mapBasedTarget(const ::std::string&, const ::RoboCompInverseKinematics::StringMap&, const ::RoboCompInverseKinematics::ScalarMap&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_mapBasedTarget(const ::std::string&, const ::RoboCompInverseKinematics::StringMap&, const ::RoboCompInverseKinematics::ScalarMap&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual ::Ice::Int mapBasedTarget(const ::std::string&, const ::RoboCompInverseKinematics::StringMap&, const ::RoboCompInverseKinematics::ScalarMap&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
...
public:
    ...
    virtual ::Ice::Int mapBasedTarget(const ::std::string&, const ::RoboCompInverseKinematics::StringMap&, const ::RoboCompInverseKinematics::ScalarMap&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
...
public:
    ...
    virtual ::Ice::Int mapBasedTarget(const ::std::string&, const ::RoboCompInverseKinematics::StringMap&, const ::RoboCompInverseKinematics::ScalarMap&, const ::Ice::Current& = ::Ice::Current()) = 0;
...
template<class T>
class CallbackNC_InverseKinematics_mapBasedTarget : public Callback_InverseKinematics_mapBasedTarget_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_InverseKinematics_mapBasedTarget(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), response(cb)
    {
    }
...
template<class T> Callback_InverseKinematics_mapBasedTargetPtr
newCallback_InverseKinematics_mapBasedTarget(const IceUtil::Handle<T>& instance, void (T::*cb)(::Ice::Int), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_InverseKinematics_mapBasedTarget<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_InverseKinematics_mapBasedTargetPtr
newCallback_InverseKinematics_mapBasedTarget(T* instance, void (T::*cb)(::Ice::Int), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_InverseKinematics_mapBasedTarget<T>(instance, cb, excb, sentcb);
}

template<class T, typename CT>
class Callback_InverseKinematics_mapBasedTarget : public Callback_InverseKinematics_mapBasedTarget_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_InverseKinematics_mapBasedTarget(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), response(cb)
    {
    }
...
template<class T, typename CT> Callback_InverseKinematics_mapBasedTargetPtr
newCallback_InverseKinematics_mapBasedTarget(const IceUtil::Handle<T>& instance, void (T::*cb)(::Ice::Int, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_InverseKinematics_mapBasedTarget<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_InverseKinematics_mapBasedTargetPtr
newCallback_InverseKinematics_mapBasedTarget(T* instance, void (T::*cb)(::Ice::Int, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_InverseKinematics_mapBasedTarget<T, CT>(instance, cb, excb, sentcb);
}
