...
/** \mainpage RoboComp::dialogagent
 *
 * \section intro_sec Introduction
 *
 * The dialogagent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/dialogagent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class dialogagent : public RoboComp::Application
{
public:
	dialogagent (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
