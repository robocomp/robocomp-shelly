...
/** \mainpage RoboComp::oracleAgent
 *
 * \section intro_sec Introduction
 *
 * The oracleAgent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/oracleAgent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class oracleAgent : public RoboComp::Application
{
public:
	oracleAgent (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::oracleAgent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
