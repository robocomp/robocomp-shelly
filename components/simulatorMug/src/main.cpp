...
/** \mainpage RoboComp::simulatormug
 *
 * \section intro_sec Introduction
 *
 * The simulatormug component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/simulatormug --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class simulatormug : public RoboComp::Application
{
public:
	simulatormug (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::simulatormug::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
