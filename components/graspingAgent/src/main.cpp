...
/** \mainpage RoboComp::graspingComp
 *
 * \section intro_sec Introduction
 *
 * The graspingComp component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/graspingComp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
{
public:
	graspingComp (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::graspingComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
