...
# \mainpage RoboComp::conversation
#
...
#
# Just: "${PATH_TO_BINARY}/conversation --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
	...
	try:
		...
		try:
			...
			try:
				...
				agmexecutive_proxy = RoboCompAGMExecutive.AGMExecutivePrx.checkedCast(basePrx)
