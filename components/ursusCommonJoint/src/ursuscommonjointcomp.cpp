...
class UrsusCommonJointComp : public RoboComp::Application
{
private:
...
void UrsusCommonJointComp::initialize()
{
...
JointMotorPrx jointmotor1_proxy;
	...
	try
	{
		...
		// Server adapter creation and publication
		Ice::ObjectAdapterPtr adapterJointMotor = communicator()->createObjectAdapter("JointMotorComp");
